...
const AdminForScanStaff = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/api/auth/scan-staff/register', {
        method: "POST",
        headers: {
      ...
      toast.success("Scan Staff registered successfully!");
...
export default AdminForScanStaff; 